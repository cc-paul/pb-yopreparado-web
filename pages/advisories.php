...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
							...
							<div class="tab-pane active" id="admin">
								<div class="row">
									...
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnAddNotification" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
									...
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnExportNotification" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
								...
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="table-container">
											<table id="tblNotif" name="tblNotif" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
												<thead>
													<tr>
														<th>Event</th>
														<th>Title</th>
		...
		<script src="../program_assets/js/web_functions/advisories.js?random=<?php echo uniqid(); ?>"></script>
