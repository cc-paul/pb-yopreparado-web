	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<!-- Main content -->
				<section class="content col-md-9 col-xs-12">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#admin" data-toggle="tab" aria-expanded="true" class="cust-label">Question and Answer List</a></li>
								...
								<div class="row">
									<div class="col-md-8 col-xs-12">
										<div class="form-group">
											<input id="txtSearchFAQ" class="form-control input-sm cust-label" type="text" placeholder="Search FAQ here...">
										</div>
									</div>
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnAddFAQ" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
									...
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnExportFAQ" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
								...
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="table-container">
											<table id="tblFAQ" name="tblFAQ" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
												<thead>
													<tr>
														<th>Question</th>
														<th>Answer</th>
		...
		<!-- Modal Name  -->
		<div class="modal fade" id="mdFAQ" name="mdFAQ">
			<div class="modal-dialog modal-md">
				<div class="box box-default">
					<div class="box-header with-border">
						<label class="cust-label">FAQ Form</label>
					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Question</label>
									<label class="cust-label text-danger">*</label>
									<textarea id="txtQuestion" name="txtQuestion" rows="5" cols="50" class="form-control cust-label cust-textbox" placeholder="Please provide details of the question"></textarea>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Answer</label>
									<label class="cust-label text-danger">*</label>
									<textarea id="txtAnswer" name="txtAnswer" rows="5" cols="50" class="form-control cust-label cust-textbox" placeholder="Please provide details of the answer"></textarea>
								</div>
							</div>
						</div>
					</div>
					<div class="box-footer">
						<div class="row">
							...
							<div class="col-md-4 col-xs-6">
								<button id="btnSaveFAQ" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
		...
		<script src="../program_assets/js/web_functions/faq.js?random=<?php echo uniqid(); ?>"></script>
