...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
				...
				<section class="content col-md-10 col-xs-12">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#admin" data-toggle="tab" aria-expanded="true" class="cust-label">Contact Information</a></li>
								...
								<div class="row">
									<div class="col-md-8 col-xs-12">
										<div class="form-group">
											<input id="txtSearchContact" class="form-control input-sm cust-label" type="text" placeholder="Search contact here...">
										</div>
									</div>
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnAddContact" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
									...
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnExportContact" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
								...
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="table-container">
											<table id="tblHotline" name="tblHotline" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
												<thead>
													<tr>
														<th>Hotline Name or POC</th>
														<th>Mobile Number</th>
		...
		<!-- Modal Name  -->
		<div class="modal fade" id="mdAddHotline" name="mdAddHotline">
			<div class="modal-dialog modal-md">
				<div class="box box-default">
					<div class="box-header with-border">
						<label class="cust-label">Hotline Form</label>
					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Hotline Name or POC</label>
									<label class="cust-label text-danger">*</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtHotline" name="txtHotline" placeholder="Enter Hotline Name or POC" >
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Mobile Number	</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtMobileNumber" name="txtMobileNumber" placeholder="Enter Mobile Number (09XXXXXXXXX)" maxlength="11" onkeyup="numOnly(this)">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Telephone Number	</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtTelephoneNumber" name="txtTelephoneNumber" placeholder="Enter Telephone Number (XXXXXXXXXX)" maxlength="10" onkeyup="numOnly(this)">
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-md-12">
								<code>Please provide at least 1 contact number</code>
							</div>
						</div>
						<br>
						<div class="row">
					...
					<div class="box-footer">
						<div class="row">
							...
							<div class="col-md-4 col-xs-6">
								<button id="btnRemoveHotline" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
							...
							<div class="col-md-4 col-xs-6">
								<button id="btnSaveHotline" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
		...
		<script src="../program_assets/js/web_functions/hotline.js?random=<?php echo uniqid(); ?>"></script>
