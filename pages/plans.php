...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
				...
				<section class="content col-md-10 col-xs-12">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#contingency" data-toggle="tab" aria-expanded="true" class="cust-label">Contingency</a></li>
							<li class=""><a href="#drmm" data-toggle="tab" aria-expanded="false" class="cust-label">Disaster Risk Reduction and Management</a></li>
						</ul>
						<div class="tab-content">
							<div class="tab-pane active" id="contingency">
								<div class="row">
							...
							<div class="tab-pane" id="drmm">
								<div class="row">
									<div class="col-md-10 col-xs-6">
										
									</div>
									<div class="col-md-2 col-xs-6">
										<button id="btnSaveChanges_drrm" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
											<i class="fa fa-save"></i>
											&nbsp;
											Save Changes
										</button>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12 ">
										<div class="toolbar_drrm"></div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="editor_drrm"></div>
									</div>
								</div>
							</div>
						</div>
		...
		<script src="../program_assets/js/web_functions/contingency.js?random=<?php echo uniqid(); ?>"></script>
