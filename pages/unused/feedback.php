...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
				...
				<section class="content col-md-8 col-sm-12">
					<div class="box box-default">
						<div class="box-header with-border">
							<p class="box-title">List of Created Feedbacks</p>
						</div>
						<div class="box-body">
							<div class="row">
								<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-12 col-sm-12">
									<div class="table-container">
										<table id="tblFeedBack" name="tblFeedBack" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
											<thead>
												<tr>
													<th>Customer Name</th>
													<th>Date</th>
		...
		<script src="../program_assets/js/web_functions/feedback.js?random=<?php echo uniqid(); ?>"></script>
