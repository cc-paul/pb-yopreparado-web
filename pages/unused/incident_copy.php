				...
				<section class="content">
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							<div class="row">
								<div class="col-md-1">
									<button id="btn_ok" name="btn_ok" type="button" class="btn btn-default btn-sm"><i class="fa fa-check"></i>
										&nbsp; Okay
									</button>
								</div>
								<div class="col-md-1">
									<button id="btn_confirm" name="btn_confirm" type="button" class="btn btn-default btn-sm"><i class="fa fa-check"></i>
										&nbsp; Okay
									</button>
								</div>
							</div>
