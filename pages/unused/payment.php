	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<!-- Main content -->
				<section class="content col-md-4 col-sm-12">
					<div class="box box-default">
						<div class="box-header with-border">
							<p class="box-title">List of Created Payments</p>
						</div>
						<div class="box-body">
							<div class="row">
								<div class="col-md-9">
								...
								<div class="col-md-3">
									<button id="btnAdd" name="btnAdd" type="button" class="btn btn-default btn-sm" style="width: 100%"><i class="fa fa-money"></i>
										&nbsp; Genereate
									</button>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12 col-sm-12">
									<div class="table-container">
										<table id="tblPayments" name="tblPayments" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
											<thead>
												<tr>
													<th>Reference</th>
													<th>Amount</th>
		...
		<script src="../program_assets/js/web_functions/payment.js?random=<?php echo uniqid(); ?>"></script>
