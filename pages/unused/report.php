...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
				...
				<section class="content col-md-6 col-sm-12">
					<div class="box box-default">
						<div class="box-header with-border">
							<p class="box-title">List of Sales Report</p>
						</div>
						<div class="cust-div-height">
						</div>
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#tab_1" data-toggle="tab" class="cust-label">Therapist</a></li>
								<li><a href="#tab_2" data-toggle="tab" class="cust-label">Branches</a></li>
							</ul>
							<div class="tab-content">
								<div class="tab-pane active" id="tab_1">
									<div class="row">
										<div class="col-md-4">
											<input id="txtTherapistDateFrom" name="txtTherapistDateFrom" type="date" value="<?php echo date('Y-m-d'); ?>" class="form-control cust-label cust-textbox" style="height: 30px !important;">
										</div>
										<div class="col-md-4">
											<input id="txtTherapistDateTo" name="txtTherapistDateTo" type="date" value="<?php echo date('Y-m-d'); ?>" class="form-control cust-label cust-textbox" style="height: 30px !important;">
										</div>
										<div class="col-md-4">
											<button id="btnAdd" name="btnAdd" type="button" class="btn btn-default btn-sm" style="width: 100%" onclick="loadTherapist()"><i class="fa fa-money"></i>
												&nbsp; Genereate
											</button>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-12 col-sm-12">
											<div class="table-container">
												<table id="tblTherapistSales" name="tblTherapistSales" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
													<thead>
														<tr>
								...
								<div class="tab-pane" id="tab_2">
									<div class="row">
										<div class="col-md-4">
											<input id="txtBranchDateFrom" name="txtBranchDateFrom" type="date" value="<?php echo date('Y-m-d'); ?>" class="form-control cust-label cust-textbox" style="height: 30px !important;">
										</div>
										<div class="col-md-4">
											<input id="txtBranchDateTo" name="txtBranchDateTo" type="date" value="<?php echo date('Y-m-d'); ?>" class="form-control cust-label cust-textbox" style="height: 30px !important;">
										</div>
										<div class="col-md-4">
											<button id="btnAdd" name="btnAdd" type="button" class="btn btn-default btn-sm" style="width: 100%" onclick="loadBranch()"><i class="fa fa-money"></i>
												&nbsp; Genereate
											</button>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-12 col-sm-12">
											<div class="table-container">
												<table id="tblBranchSales" name="tblBranchSales" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
													<thead>
														<tr>
															<th>Branch Name</th>
															<th>Address</th>
		...
		<script src="../program_assets/js/web_functions/report.js?random=<?php echo uniqid(); ?>"></script>
