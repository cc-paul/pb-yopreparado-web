...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
				...
				<section class="content col-md-12 col-sm-12">
					<div class="box box-default">
						<div class="box-header with-border">
							<p class="box-title">List of Created Reservation</p>
						</div>
						<div class="box-body">
							<div class="row">
								<div class="col-md-12">
									<input id="txtSearch" name="txtSearch" type="text" class="form-control cust-label cust-textbox" placeholder="Seach data here....">
								</div>
							</div>
							<br>
							<div class="row">
								<div class="col-md-12 col-sm-12">
									<div class="table-container">
										<table id="tblReservation" name="tblReservation" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
											<thead>
												<tr>
													<th>Ref</th>
													<th>Branch</th>
		...
		<div class="modal fade" id="mdPaymentGenerator" name="mdPaymentGenerator">
			<div class="modal-dialog modal-sm">
				<div class="box box-default">
					<div class="box-header with-border">
						<label class="cust-label">Payment Form</label>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<div class="form-group">
									<label for="txtAmount" class="cust-label">Amount</label>
									<label for="txtAmount" class="cust-label text-danger">*</label>
									<input type="number" class="form-control cust-label cust-textbox" id="txtAmount" name="txtAmount" placeholder="Input amount tendered" autocomplete="off">
								</div>
							</div>
						</div>
					</div>
					<div class="box-footer">
						<div class="row">
							<div class="col-md-12">
								<button id="btnSave" name="btnSave" type="button" class="btn btn-default btn-sm" style="width: 100%"><i class="fa fa-save"></i>
									&nbsp; Save and Generate Reference
								</button>
							</div>
						</div>
					</div>
		...
		<div class="modal fade" id="mdDetails" name="mdDetails">
			<div class="modal-dialog modal-md">
				<div class="box box-default">
					<div class="box-header with-border">
						<label class="cust-label">Reservation Details</label>
						<button type="submit" class="btn btn-default btn-xs pull-right" data-dismiss="modal"><i class="fa fa-close"></i>
						</button>
					</div>
					<div class="box-body">
						<div class="row">
							<div class="col-md-4 col-xs-12">
								<label class="cust-label">Ref #: &nbsp;</label><span id="spRef" class="cust-label">{value}</span>
							</div>
							<div class="col-md-4 col-xs-12">
								<label class="cust-label">Branch: &nbsp;</label><span id="spBranch" class="cust-label">{value}</span>
							</div>
							<div class="col-md-4 col-xs-12">
								<label class="cust-label">Therapist: &nbsp;</label><span id="spTherapist" class="cust-label">{value}</span>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4 col-xs-12">
								<label class="cust-label">Customer: &nbsp;</label><span id="spCustomer" class="cust-label">{value}</span>
							</div>
							<div class="col-md-4 col-xs-12">
								<label class="cust-label">Date: &nbsp;</label><span id="spDate" class="cust-label">{value}</span>
							</div>
							<div class="col-md-4 col-xs-12">
								<label class="cust-label">Time: &nbsp;</label><span id="spTime" class="cust-label">{value}</span>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4 col-xs-12">
								<label class="cust-label">Price: &nbsp;</label><span id="spPrice" class="cust-label">{value}</span>
							</div>
							<div class="col-md-4 col-xs-12">
								<label class="cust-label">Mobile Number: &nbsp;</label><span id="spMobileNumber" class="cust-label">{value}</span>
							</div>
						</div>
						<br>
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<div class="form-group">
									<label for="txtRemarks" class="cust-label">Remarks</label>
									<textarea id="txtRemarks" name="txtRemarks" class="form-control cust-label cust-textbox" rows="5" placeholder="No remarks for this reservation" style="resize: none;" disabled></textarea>
								</div>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label for="cmbStatus" class="cust-label">Status</label>
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label for="cmbDriver" class="cust-label">Driver</label>
									<select id="cmbDriver" name="cmbDriver" class="form-control select2 cust-label cust-textbox" style="width: 100%;">
										...
										<?php
											include dirname(__FILE__,2) . '/program_assets/php/dropdown/driver.php';
										?>
									</select>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<div class="form-group">
									<label for="txtReason" class="cust-label">Reason (If Rejected)</label>
									<textarea id="txtReason" name="txtReason" class="form-control cust-label cust-textbox" rows="5" placeholder="No reason for this reservation" style="resize: none;"></textarea>
								</div>
							</div>
						</div>
					</div>
					<div class="box-footer">
						<div class="row">
							<div class="col-md-12">
								<button id="btnSaveReserve" name="btnSaveReserve" type="button" class="btn btn-default btn-sm" style="width: 100%"><i class="fa fa-save"></i>
									&nbsp; Save Changes
								</button>
							</div>
						</div>
		...
		<script src="../program_assets/js/web_functions/reservation.js?random=<?php echo uniqid(); ?>"></script>
