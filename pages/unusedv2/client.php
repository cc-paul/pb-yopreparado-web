...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
									...
									<div class="row">
										<div class="col-md-6 col-xs-12">
											<div class="form-group">
												...
												<input type="text" class="form-control cust-label cust-textbox" id="txtClientsName" name="txtClientsName" disabled>
											</div>
										</div>
										<div class="col-md-6 col-xs-12">
											<div class="form-group">
												<label class="cust-label">Contact Person</label>
												<input type="text" class="form-control cust-label cust-textbox" id="txtClientsContactPerson" name="txtClientsContactPerson" disabled>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12 col-xs-12">
											<div class="form-group">
												...
												<textarea id="txtClientsAddress" class="form-control cust-label cust-textbox" style="overflow:auto;resize:none" rows="3" cols="20" disabled></textarea>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-6 col-xs-12">
											<div class="form-group">
												...
												<input type="text" class="form-control cust-label cust-textbox" id="txtClientsContactNumber" name="txtClientsContactNumber" maxlength="11" onkeyup="numOnly(this)" disabled>
											</div>
										</div>
										<div class="col-md-6 col-xs-12">
											<div class="form-group">
												<label class="cust-label">Landline</label>
												<input type="text" class="form-control cust-label cust-textbox" id="txtClientsLandLine" name="txtClientsLandLine" maxlength="10" onkeyup="numOnly(this)" disabled>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-6 col-xs-12">
											<div class="form-group">
												...
												<input type="text" class="form-control cust-label cust-textbox" id="txtClientsEmailAddress" name="txtClientsEmailAddress" disabled>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="row">
									...
									<div class="row">
										<div class="col-md-12 col-sm-12">
											<div class="table-container">
												<table id="tblClients" name="tblClients" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
													<thead>
														<tr>
															<th>Area</th>
															<th>Address</th>
								...
								<div class="col-md-7 col-sm-12">
									...
									<div class="row">
										<div class="col-md-12 col-sm-12">
											<div class="table-container">
												<table id="tblEmployee" name="tblEmployee" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
													<thead>
														<tr>
															<th>Employee ID</th>
															<th>First Name</th>
		...
		<script src="../program_assets/js/web_functions/client.js?random=<?php echo uniqid(); ?>"></script>
