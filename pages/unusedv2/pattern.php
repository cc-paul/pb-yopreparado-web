								...
								<div class="row">
									<div class="col-md-8 col-xs-12">
										<div class="form-group">
											<input class="form-control input-sm cust-label" type="text" placeholder="Search account here...">
										</div>
									</div>
									...
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button type="button" class="btn btn-block btn-success btn-sm cust-textbox">
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<select id="cmbPosition" name="cmbPosition" class="form-control select2 cust-label cust-textbox" style="width: 100%;">
										<option value="" selected disabled>-- Please select a postion --</option>
										<?php
